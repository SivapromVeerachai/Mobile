...
import 'package:my_first_app/model/request/response/cusidx_get_res.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  late CusIdxGetRes cusIdxGetResponse;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Image.network(cusIdxGetResponse.image, width: 150),
                  ),
                  Padding(
  ...
  Future<void> loadDataAsync() async {
    ...
    log(res.body);
    cusIdxGetResponse = cusIdxGetResFromJson(res.body);
    nameCtl.text = cusIdxGetResponse.fullname;
    phoneCtl.text = cusIdxGetResponse.phone;
    emailCtl.text = cusIdxGetResponse.email;
    imageCtl.text = cusIdxGetResponse.image;
  }
}
